  ...
  return (
    ...
    >
      <div className="relative h-40 w-full overflow-hidden ui-media-placeholder">
        <div className="absolute inset-0 animate-pulse ui-media-placeholder opacity-75" />
        <div className="absolute right-2 top-2 h-5 w-16 rounded-full bg-surface-muted animate-pulse" />
        <div className="absolute bottom-2 left-3 right-3 space-y-2">
          <div className="h-3.5 w-[88%] max-w-full rounded-md bg-surface-muted animate-pulse" />
          <div className="h-3 w-[55%] rounded-md bg-surface-muted animate-pulse" />
        </div>
      </div>
    </div>
  );
